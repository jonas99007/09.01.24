...
export default function Example() {
  return (
    ...
    backgroundPosition: 'center', }}>
      <div className="mx-auto grid max-w-9xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <h2 className="text-7xl font-bold tracking-tight text-gray-100">Wir freuen uns auf ihre Kontaktaufnahme</h2>
            <p className="mt-6 text-lg leading-8 text-gray-100 opacity-0">
               Orci molestie a eu arcu. Sed ut tincidunt
              integer elementum id sem. Arcu sed malesuada et magna.
            </p>
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-100">
              ...
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  ...
                  <PhoneIcon className="h-7 w-6 text-gray-100" aria-hidden="true" />
                </dt>
                <dd>
              ...
              <div className="flex gap-x-4 text-bold ">
                <dt className="flex-none">
                  ...
                  <EnvelopeIcon className="h-7 w-6 text-gray-100" aria-hidden="true" />
                </dt>
                <dd>
                  <a className="hover:text-gray-100" href="mailto:hello@example.com">
                  info@tennishallen-schwarz-weiss.de
                  </a>
                </dd>
              </div>
            </dl>
