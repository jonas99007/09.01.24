...
export default function Example() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-white" style={{ backgroundImage: 'url("/Tennis.jpg")', backgroundSize: 'cover', // Ensure the background image covers the entire container
